...
function LeapAccountWizard()
{
  this._init();
}
LeapAccountWizard.prototype =
{
  _init : function LeapAccountWizard__init()
  {
  ...
  {
    if (this._abortable) {
      this._abortable.cancel(new Exception());
    }
...
var gLeapAccountWizard = new LeapAccountWizard();
